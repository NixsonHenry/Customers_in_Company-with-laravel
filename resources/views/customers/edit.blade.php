            ...
            <div class="w-full font-serif">
                <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                    ...
                    <header class="font-semibold bg-gray-200 text-gray-700 text-lg font-serif font-bold py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md">
                        {{ __('Edit details for ' . $customer->name) }}
                    </header>

                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('customers.update', ['customer' => $customer]) }}" enctype="multipart/form-data">
